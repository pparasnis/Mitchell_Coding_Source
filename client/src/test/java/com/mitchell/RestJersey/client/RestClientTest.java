...
import com.mitchell.rest.client.RestClient;

public class RestClientTest {

	@Before
	public void setUp() throws Exception {
		testCreateClaimClientService();
	}

	@After
	public void tearDown() throws Exception {
		testDeleteClaimClientService();
	}
	...
	public void testFindClaimbyLossDateClientService() throws Exception {
		...
		assertTrue(restClient.findClaimbyLossDateClientService(sDate, eDate)
				.getClaims().size() > 0);
		// /other assert statements to check remaining fields
	}
